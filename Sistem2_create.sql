...
-- Last modification date: 2019-03-06 06:59:20.529
create database restauranteii
go
use restauranteii
go
-- tables
...
CREATE TABLE HORARIO (
    CODHOR int  primary key identity(1,1),
    ENTRHOR time   NULL,
    SALHOR time   NULL,
    FECHHOR date   NULL,    
)
...
CREATE TABLE HORARIO_DETALLE (
    CODDET int  primary key identity(1,1),
    HORARIO_CODHOR int   NULL,
    PERSONA_CODPER int   NULL,
...
-- Table: MESA
CREATE TABLE MESA (
    CODMES int primary key identity(1,1),
    CAPMES char(2)   NULL,
    ESTMES char(1)   NULL,
    NUMMES char(2)   NULL,
    SUCURSAL_CODSUC int   NULL,
    PLATOS_CODPLAT int   NULL,
...
CREATE TABLE PERSONA (
    CODPER int primary key identity(1,1) ,
    NOMPER varchar(150)   NULL,
    APELLPER varchar(150)   NULL,
    DOCPER char(11)   NULL,
    DIRPER varchar(125)   NULL,
    TIPPER char(1)   NULL,
    USERPER char(8)   NULL,
    PASSPER varchar(10)   NULL,
    UBIGEO_CODUBI char(6)   NULL,
...
CREATE TABLE PLATOS (
    ...
    NOMPLAT varchar(150)   NULL,
    DESPLAT varchar(150)   NULL,
    TIPPLAT varchar(150)   NULL,
    PREPLAT decimal(12,2)   NULL,
    ESTPLAT char(2)   NULL,
...
CREATE TABLE SUCURSAL (
    CODSUC int   primary key identity(1,1),
    DIRSUC varchar(125)   NULL,
    TELSUC char(9)   NULL,
    UBIGEO_CODUBI char(6)   NULL,
...
CREATE TABLE UBIGEO (
    ...
    PROUBI varchar(150)   NULL,
    DEPUBI varchar(150)   NULL,
    DISUBI varchar(150)   NULL,
...
CREATE TABLE VENTA (
    ...
    CANTVEN int   NULL,
    CODPERPERSONAL int   NULL,
    CODPERCLIENTE int   NULL,
    MESA_CODMES int   NULL,
...
CREATE TABLE VENTA_DETALLE (
    CODVENTDET int  primary key identity(1,1),
    VENTA_CODVEN int   NULL,
    
)
go

-- foreign keys
-- Reference: HORARIO_DETALLE_HORARIO (table: HORARIO_DETALLE)
ALTER TABLE HORARIO_DETALLE ADD CONSTRAINT HORARIO_DETALLE_HORARIO
    FOREIGN KEY (HORARIO_CODHOR)
    REFERENCES HORARIO (CODHOR)
	go

-- Reference: HORARIO_DETALLE_PERSONA (table: HORARIO_DETALLE)
ALTER TABLE HORARIO_DETALLE ADD CONSTRAINT HORARIO_DETALLE_PERSONA
    FOREIGN KEY (PERSONA_CODPER)
    REFERENCES PERSONA (CODPER)
	go

-- Reference: MESA_PLATOS (table: MESA)
ALTER TABLE MESA ADD CONSTRAINT MESA_PLATOS
    FOREIGN KEY (PLATOS_CODPLAT)
    REFERENCES PLATOS (CODPLAT)
	go

-- Reference: MESA_SUCURSAL (table: MESA)
ALTER TABLE MESA ADD CONSTRAINT MESA_SUCURSAL
    FOREIGN KEY (SUCURSAL_CODSUC)
...
-- Reference: VENTA_MESA (table: VENTA)
ALTER TABLE VENTA ADD CONSTRAINT VENTA_MESA
    FOREIGN KEY (MESA_CODMES)
    REFERENCES MESA (CODMES)
	go

-- Reference: VENTA_PERSONA (table: VENTA)
ALTER TABLE VENTA ADD CONSTRAINT VENTA_PERSONA
    FOREIGN KEY (CODPERPERSONAL)
    REFERENCES PERSONA (CODPER)
	go
...
insert into ubigeo(codubi, proubi, depubi, disubi)values
...
insert into sucursal (dirsuc,telsuc ,ubigeo_codubi)values
('Av. 234 Ramos','963204251','150507')
go

select codven, NOMPER, apellper from venta, persona where codven=1111 and codper=12   
go
...
insert into mesa (capmes, estmes, nummes,sucursal_codsuc)values
('4','s','2',1),
('4','s','3',1),
('8','s','4',1),
('4','n','5',1)
