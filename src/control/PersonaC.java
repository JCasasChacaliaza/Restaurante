...
public class PersonaC implements Serializable {
    ...
    public void variable() {
        ...
        public void PersonaII(){
            try {
            persona.setNomPer(PersonaVTI.txtNombreVTI.getText());
            persona.setApePer(PersonaVTI.txtApellidoVTI.getText());
            persona.setDirPer(PersonaVTI.txtDireccVTI.getText());
            persona.setDniPer(PersonaVTI.txtDocVTI.getText());
            persona.setTipPer(PersonaVTI.txtCliente.getText());
            } catch (Exception e) {
                throw e;
            }
    ...
    public void limpiarII() {
        
        
        PersonaVTI.txtNombreVTI.setText("");
        PersonaVTI.txtApellidoVTI.setText("");                
        PersonaVTI.txtDireccVTI.setText("");                
        PersonaVTI.txtDocVTI.setText("");
    }
