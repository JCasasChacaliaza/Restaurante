...
public class Exportar extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String nombre = "\\restaurante.bak";
        String backus = "";
        if(ruta.trim().length()!=0){
            try{
                backus = "Backup-SqlDatabase -ServerInstance"+Conexion.getLocal()+" -Database"+Conexion.getBd()+" -BackupAction Database"+ruta+nombre ;
                Runtime rt = Runtime.getRuntime();
                rt.exec(backus);
                JOptionPane.showMessageDialog(null, "Restaurante creado: "+ruta);
            }catch(Exception ex){
